...
gcloud compute forwarding-rules delete "$FW_RULE_HTTP" --global --quiet
...
gcloud compute addresses delete "$IP_LB" --global --quiet
...
gcloud compute instance-groups managed delete "$INSTANCE_GROUP"  --zone $DEF_ZONE --quiet
